...
<div>
    <div class="row">
        <div class="col-xs-2">
            <h4><a href="home.php"><i class="fa fa-home"></i>Home</a></h4>
        </div>
        <div class="col-xs-8">
    ...
    <div class="row">
        ...
        <div class="col-xs-3">
            ...
            <div class="dropdown">
                <button id="sample_button" class="btn dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">Upload Document
