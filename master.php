...
<div>
    <div class="row">
        <div class="col-xs-2">
            <h4><a href="admin_home.php"><i class="fa fa-home"></i>Home</a></h4>
        </div>
        <div class="col-xs-8">
    ...
    <div class="row">
        ...
        <div class="col-xs-2">
            ...
            <div class="dropdown">
                <button id="sample_button" class="btn dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">Upload
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<li>
                                        ...
                                        <form action='admin_upload.php' method='post'>
                                            ...
                                            id='drop'
                                            onclick='location.href='display_all.php';'>"
                            ."</form>
        ...
        <div class="col-xs-2">
            <form action="add_event.php">
                <input type="submit" value="Add Event" id="sample_button" class="btn">
            </form>
        </div>
        <div class="col-xs-2">
            <form action="add_user.php">
                <input type="submit" value="Add User" id="sample_button" class="btn">
            </form>
        </div>
